...
<template>
  <div class="w-full space-y-1">
    ...
    <select
      ...
      :value="modelValue"
      :disabled="disabled"
      class="w-full bg-[#0B0E14] text-[#F8FAFC] border border-[#1E293B] hover:border-[#334155] focus:border-[#38BDF8] rounded text-xs px-3 py-2 transition-all duration-150 focus-ring disabled:opacity-50 disabled:cursor-not-allowed font-sans"
      @change="onChange"
    >
      <slot />
    </select>
