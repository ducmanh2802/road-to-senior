// scripts/runPhase.cjs
// Simple runner for migration phases (CommonJS). Executes lint, tests, and build for UI phases.
// Usage: node scripts/runPhase.cjs <phase-number>
