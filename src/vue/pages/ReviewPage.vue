    ...
    <Card v-if="currentCard" variant="elevated" padding="none">
      ...
      <div class="p-4 bg-[#151B28] border-b border-[#1E293B] flex flex-wrap items-center justify-between gap-2 font-mono text-xs">
        <div class="flex items-center gap-2">
          ...
          <span class="text-[#94A3B8]">
            Interval: <strong class="text-[#F8FAFC]">{{ currentCard.intervalDays }}d</strong> · Reps: {{ currentCard.repetitionCount }}
          </span>
        </div>
      ...
      <div class="p-6 space-y-5">
        ...
        <div v-else class="space-y-5 pt-4 border-t border-[#1E293B]">
          <div class="p-4 bg-[#151B28] border border-[#22C55E]/30 rounded-xl space-y-3">
            ...
            <p class="text-sm text-[#F8FAFC] whitespace-pre-wrap leading-relaxed">
