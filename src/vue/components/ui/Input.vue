...
const inputClasses = computed(
  () => `w-full bg-[#0B0E14] text-[#F8FAFC] border rounded text-xs px-3 py-2 transition-all duration-150 placeholder-[#64748B] focus-ring disabled:opacity-50 disabled:cursor-not-allowed ${
